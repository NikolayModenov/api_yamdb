...
class TextAuthorDateFieldsBase(models.Model):
...
class Review(TextAuthorDateFieldsBase):
    ...
    class Meta(TextAuthorDateFieldsBase.Meta):
        verbose_name = 'Отзыв'
...
class Comment(TextAuthorDateFieldsBase):
